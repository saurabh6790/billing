...
const failures = createResource({ url: 'press_billing.admin.get_payment_failures', auto: true });
const analytics = createResource({ url: 'press_billing.admin.get_payment_analytics', auto: true });
</script>
